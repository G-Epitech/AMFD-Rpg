...
static void display_script_bash(node_t *competence)
{
...
static void display_flipper(node_t *competence)
{
    if (COMPETENCE_UNLOCK(competence)) {
        return;
    } else {
...
static void display_brute_force(node_t *competence)
{
    if (COMPETENCE_UNLOCK(competence)) {
        return;
    } else {
...
static void display_go_buster(node_t *competence)
{
    if (COMPETENCE_UNLOCK(competence)) {
        return;
    } else {
