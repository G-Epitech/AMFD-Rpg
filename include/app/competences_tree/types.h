...
*/
    ...
    #define RECT_GOBUSTER(world_pos) 811 <= world_pos.x && world_pos.x <= 811 + 297 && 464 <= world_pos.y && world_pos.y <= 464 + 173
    ...
    #define RECT_BRUTE(world_pos) 811 <= world_pos.x && world_pos.x <= 811 + 304 && 238 <= world_pos.y && world_pos.y <= 238 + 173
    ...
    #define RECT_FLIPPER(world_pos) 1104 <= world_pos.x && world_pos.x <= 1104 + 306 && 690 <= world_pos.y && world_pos.y <= 690 + 173
    ...
    #define RECT_BASH_SPRITE(world_pos) 516 <= world_pos.x && world_pos.x <= 516 + 297 && 690 <= world_pos.y && world_pos.y <= 690 + 173
